        ...
        <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' }}>
          <div className="max-w-[1400px] mx-auto p-6 md:p-8">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              {/* Form Panel */}
              <div className="lg:w-2/5 no-print">
                <div className="bg-white rounded-2xl shadow-xl p-6 sticky top-6 border border-gray-200 max-h-[85vh] overflow-y-auto">
                  ...
                  <div className="mb-5"><label className="text-xs font-semibold uppercase text-gray-500">Professional Summary</label><textarea rows={2} value={summary} onChange={(e) => setSummary(e.target.value)} className="w-full border rounded-xl p-2 mt-1"></textarea></div>
                  <div className="mb-5"><label className="text-xs font-semibold uppercase text-gray-500">Skills (comma separated)</label><input type="text" value={skills} onChange={(e) => setSkills(e.target.value)} className="w-full border rounded-xl p-2 mt-1" /></div>
                  ...
                  {/* Work Experience */}
                  <div className="mb-6">
                    <div className="flex justify-between items-center"><label className="font-bold text-gray-800"><i className="fas fa-briefcase text-yellow-600"></i> Work Experience</label><button onClick={addExperience} className="text-xs bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 rounded-full"><i className="fas fa-plus"></i> Add Role</button></div>
                    <div className="space-y-3 mt-3 max-h-60 overflow-y-auto">
                      {experiences.map(exp => (
                        <div key={exp.id} className="bg-gray-50 p-3 rounded-xl border">
                  ...
                  {/* Education */}
                  <div className="mb-6">
                    <div className="flex justify-between items-center"><label className="font-bold text-gray-800"><i className="fas fa-university"></i> Education</label><button onClick={addEducation} className="text-xs bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 rounded-full"><i className="fas fa-plus"></i> Add Degree</button></div>
                    <div className="space-y-3 mt-3">
                      {educations.map(edu => (
                        <div key={edu.id} className="bg-gray-50 p-3 rounded-xl border">
                  ...
                  {/* Certificates */}
                  <div className="mb-5">
                    <div className="flex justify-between items-center"><label className="font-bold text-gray-800"><i className="fas fa-certificate"></i> Certifications</label><button onClick={addCertificate} className="text-xs bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 rounded-full"><i className="fas fa-plus"></i> Add Certificate</button></div>
                    <div className="space-y-3 mt-3">
                      {certificates.map(cert => (
                        <div key={cert.id} className="bg-gray-50 p-3 rounded-xl border">
              ...
              <div className="lg:w-3/5">
                <div className="bg-white rounded-2xl shadow-2xl overflow-hidden print:shadow-none" id="resumePreview">
